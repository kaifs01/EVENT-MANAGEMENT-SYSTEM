...
$eid2 = $_GET['edid2'];
$select = "SELECT * FROM `bookings` WHERE `id`='$eid2'";
$exc0 = mysqli_query($cn, $select);
$row = mysqli_fetch_assoc($exc0);
...
if (isset($_POST['add'])) {
    ...
    // $insert = "INSERT INTO `bookings`(`remark`,`status`) VALUES ('$rem','$stat')";
    $eid2 = $_GET['edid2'];
    $update = "UPDATE `bookings` SET `remark`='$rem',`status`='$stat' WHERE `id`='$id'";
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Booking Action</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title  -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="add_ev">
                            <form action="#" method="post">
                                <label>Remark</label>
                                <input class="evd" type="text" name="remark" value="<?php echo $rem; ?>"
                                    placeholder="Enter Event Name">

                                <label>Status</label>
                                <select name="status" value="<?php echo $stat; ?>" class="evd" id="stat">
