                                        ...
                                        <?php } else { ?>
                                            ...
                                            <td>
                                                <span class="badge bg-danger">
                                                    <?php echo $row['status'] = "Rejected"; ?>
                                                </span>
                                            </td>

                                        <?php } ?>
                                        <td>
                                            <a href="apbook_detail.php?editid=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-warning"
                                                id="<?php echo $row['id']; ?>"><i class="bx bx-show-alt" aria-hidden="true"
