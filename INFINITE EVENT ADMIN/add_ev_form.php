    ...
    <body>
        ...
        <div id="id01" class="add_ev ">
            <form method="POST" enctype="multipart/form-data">
                ...
                <input class="evd" type="text" name="Short_desc" placeholder="Enter Short Discription"
                    value="<?PHP if (isset($_GET['edit']))
                        echo $row['e_name']; ?>">

                <label>Discription</label>
                <input class="evd" type="text" name="disc" placeholder="Enter Discription"
                    value="<?PHP if (isset($_GET['edit']))
                        echo $row['e_name']; ?>">

                <label>Creation Date</label>
                <input class="evd" type="date" name="cr_date" placeholder="Enter Creation Date"
                    value="<?PHP if (isset($_GET['edit']))
                        echo $row['e_name']; ?>">
                ...
                <label>Image</label>
                <input class="evd1" type="file" id="eventImage" name="ev_img">
