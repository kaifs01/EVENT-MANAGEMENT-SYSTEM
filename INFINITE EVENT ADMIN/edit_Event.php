...
if (!isset ($_SESSION['email'])) {
    ...
    if (isset ($_POST['update'])) {
        ...
        $update = "UPDATE `events` SET `image`='$file_name',`e_name`='$s_name',`des`='$desc',sdes='$sdesc',price='$price' WHERE e_id=$_GET[edit]";
    ...
    if (isset ($_GET['edit'])) {
        $sel = "SELECT * FROM `events` WHERE e_id=$_GET[edit]";
        $result = $cn->query($sel);
    ...
    <body>
                        ...
                        <div class="card recent-sales overflow-auto">
                            <div class="card-body">
                                <div class="card-title">
                                    ...
                                    <a href="add_event1.php" type="button" class="btn btn-danger back_btn"
                                ...
                                <div class="add_ev ">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <label>Image</label>
                                        <img id="previewImage" src="assets/img/<?php echo $row['image']; ?>"
                                        ...
                                        <input class="evd" type="text" name="e_name" placeholder="Enter Event Name" value="<?PHP if (isset ($_GET['edit']))
                                            echo $row['e_name']; ?>">
                                        ...
                                        <input class="evd" type="text" name="sdesc" placeholder="Enter Short Description"
                                            name="sdes" value="<?PHP if (isset ($_GET['edit']))
                                                echo $row['sdes']; ?>">

                                        <label>Price</label>
                                        <input class="evd" type="number" placeholder="Enter Price" name="price" value="<?PHP if (isset ($_GET['edit']))
                                            echo $row['price']; ?>">
        ...
        <input class="evd1" type="file" id="eventImage" name="eventImage" accept="image/*"> -->
                                        ...
                                        <div class="manage_btn">
                                            <button name="update" class="ev_btn" type="submit">Update Event</button>
