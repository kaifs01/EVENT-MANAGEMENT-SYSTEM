...
if (isset ($_POST['login'])) {
  ...
  $select = "select * from tbladmin where email='$em' and password='$pass'";
  ...
  if ($count > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      $email = $row['email'];
      $phone = $row['phone'];
      $file_name = $row['profile']; // Fetching image path
    }
    ...
    $_SESSION['profile'] = $file_name; // Storing image path in session
  ...
  // $insert = "select * from users where username='$Name' and password='$pass'";
