...
.evd1::-webkit-file-upload-button{
  ...
  20px 20px 60px #00000041, inset 2px -3px 10px 3px #00000040
...
<div id="id02" class="add_ev ">
    <form method="POST" enctype="multipart/form-data">
   
      <span onclick="document.getElementById('id02').style.display='none'" class="close" title="Close Modal">&times;</span>
        
      <h3>update Top Event</h3>

      <label>Image</label>
      <input class="evd1" type="file" id="eventImage" name="preview">
      
      <label>Event Name</label>
      <input class="evd" type="text" name="ev_name" placeholder="Enter Event Name"   value="<?PHP if (isset($_GET['edit'])) echo $row['ev_name']; ?>">

        <label>Price</label>
        <input class="evd" type="text" placeholder="Enter Price" name="price"  value="<?PHP if (isset($_GET['edit'])) echo $row['price']; ?>">

        <label>Booking</label>
        <input class="evd" type="text" placeholder="Enter Booking" name="booking"  value="<?PHP if (isset($_GET['edit'])) echo $row['booking']; ?>">
