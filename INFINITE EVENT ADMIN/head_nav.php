    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            <li class="dropdown-header">
              ...
              new notifications
              <a href="new_booking.php"><span class="badge rounded-pill bg-primary p-2 ms-2">View all</span></a>
            </li>
            <li>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              <li class="notification-item">
                <i class="bi bi-exclamation-circle text-warning" style="font-size: 35px;"></i>
                <div class="wd-380">

                  <div>
                    <h4 style="float: left;">Event: </h4>
                    <p style="float: right; width: 115px;">
                      <?php echo $row['ev_type'] ?>
                    </p>
                  </div>
                  <div>
                    <h4 style="float: left;">Customer Name: </h4>
                    <p style="float: right;">
                      <?php echo $row['c_name'] ?>
                    </p>
                  </div>
                  <div>
                    ...
                    <p style="float: right; width: 79px;">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <?php
          // $select = "SELECT  FROM `tbladmin` WHERE `email` and `password`";
