...
if (isset($_POST['update'])) {
    ...
    $update = "UPDATE `themes` SET `image`='$file_name',`name`='$s_name',`des`='$desc',`sded`='$sdesc',`t_price`='$pri' WHERE theme_id=$_GET[edit]";

    $result = $cn->query($update);
    if ($result) {
        echo "<script>window.location.href ='view_theme.php'</script>";
    } else {
...
if (isset($_GET['edit'])) {
    $sel = "SELECT * FROM `themes` WHERE theme_id=$_GET[edit]";
    $result = $cn->query($sel);
                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <div class="card-title">
                                <h5>Update Theme</h5>
                                <a href="view_theme.php" type="button" class="btn btn-danger back_btn" data-toggle="model"
                            ...
                            <div class="add_ev ">
                                ...
                                <label>Image</label>
                                    ...
                                    <input class="evd" type="text" name="e_name" placeholder="Enter Theme Name" value="<?PHP if (isset($_GET['edit']))
                                        echo $row['name']; ?>">

                                    <label>Description</label>
                                    <input class="evd" type="text" name="desc" placeholder="Enter Description" value="<?PHP if (isset($_GET['edit']))
                                        echo $row['des']; ?>">

                                    <label>Short Description</label>
                                    <input class="evd" type="text" name="sdesc" placeholder="Enter Short Description" name="sdes"  value="<?PHP if (isset($_GET['edit']))
                                        echo $row['sded']; ?>">
                                    
                                    <label>Price</label>
                                    <input class="evd" type="text" name="t_price" placeholder="Enter Theme Price" value="<?PHP if (isset($_GET['edit']))
                                        echo $row['t_price']; ?>">
                                    ...
                                    <div class="manage_btn">
                                        <button name="update" class="ev_btn" type="submit">Update Themes</button>
