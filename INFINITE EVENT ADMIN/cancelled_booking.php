                    ...
                    <div class="card-body">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <?php
                                $select = "SELECT * FROM `bookings` WHERE status='Cancel'";
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td>
                                            <a href="booking_action.php" class="btn btn-sm btn-outline-warning"
                                                id="<?php echo $row['id']; ?>"><i class="bx bx-edit" aria-hidden="true"
