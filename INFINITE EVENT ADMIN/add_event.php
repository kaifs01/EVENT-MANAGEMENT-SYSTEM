...
//     $insert = "INSERT INTO events (`image`,`e_name`,`des`,`sdes`,`c_date`,`price`) VALUES ('$file_name','$name','$ds','$sds','$c_date','$price')";
...
if (isset ($_POST['add'])) {
    ...
    $ins="insert into events values(e_id,'$file_name','$name','$ds','$sds',$price,created_at,updated_at)";
    // $insert = "INSERT INTO `events`(`e_id`,`image`, `e_name`,`des`,`sdes`,`price`) VALUES (e_id,'$file_name','$name','$ds','$sds','$price')";
                        ...
                        <div class="card-body">
                            ...
                            <div class="add_ev ">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <input class="evd" type="text" name="s_name" placeholder="Enter Event Name">

                                    <label>Description</label>
                                    <input class="evd" type="text" placeholder="Enter Description" name="des">

                                    <label>Short Description</label>
                                    <input class="evd" type="text" placeholder="Enter Short Description" name="sdesc">

                                    <label>Price</label>
                                    <input class="evd" type="number" placeholder="Enter Price" name="price">
