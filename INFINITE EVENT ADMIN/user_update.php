...
if (isset ($_POST['update'])) {
    ...
    $update = "UPDATE `tbladmin` SET `fname`='$fname',`lname`='$lname',`phone`='$mno',`email`='$email' WHERE id='$_GET[edit]'";
...
if (isset ($_GET['edit'])) {
    $sel = "SELECT * FROM `tbladmin` WHERE id=$_GET[edit]";
    $result = $cn->query($sel);
                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <div class="card-title">
                                <h5>Update User</h5>
                                <a href="manage_user.php" type="button" class="btn btn-danger back_btn"
                            ...
                            <div class="add_ev ">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <input class="evd" type="text" name="LastName" placeholder="Enter Last Name" value="<?PHP if (isset ($_GET['edit']))
                                        echo $row['lname']; ?>">
                                    ...
                                    <label>Email</label>
                                    <input class="evd" type="Email" placeholder="Enter Email" name="Email" value="<?PHP if (isset ($_GET['edit']))
                                        echo $row['email']; ?>">
